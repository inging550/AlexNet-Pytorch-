...
# 数据集的路径根据实际情况修改
train_dataset = datasets.ImageFolder(root='F:/CCCCCProject/AlexNet/Project1/DATASET/TRAIN', transform=transform['train'])
test_dataset = datasets.ImageFolder(root='F:/CCCCCProject/AlexNet/Project1/DATASET/TEST', transform=transform['test'])
